...
<body>
    ...
    <div class="body-content">
    	<div class="login-content-wrap container ">
    		...
    		<form action="/index.php/Home/User/forget.html" method="post" class="login-form-content register-content-wrap">
    			...
    			<div class="login-input-wrap">
    				<i class="fa fa-lock"></i>
    				<input type="password" placeholder="新密码" name='password' class="login-input">
    			</div>
    			<div class="login-input-wrap">
    				<i class="fa fa-lock"></i>
